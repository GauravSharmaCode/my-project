...
>
    ...
    <div class="flex flex-col gap-4 items-center justify-center">
        ...
        <p><b class="pr-2">Email</b> <a href="mailto:shrma.gurv@gmail.com" target="_blank" rel="noopener noreferrer">shrma.gurv@gmail.com</a></p>
        <p>
            <b class="pr-2">GitHub</b>
            <a href="https://github.com/GauravSharmaCode" target="_blank" class="text-violet-400"
                >GauravSharmaCode<sup class=""
        ...
        <p>
            ...
            <a href="https://www.linkedin.com/in/gauravsharmacode/" target="_blank" class="text-violet-400"
                >gaurav_sharma-code<sup class=""
                    ><span class="text-xs scale-75 pl-0.5"
                        ><i
                            class="fa-solid fa-arrow-up-right-from-square text-xs scale-[75%]"
                        /></span
